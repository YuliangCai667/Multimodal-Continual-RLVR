...
if [ $TASK_ID -eq 1 ]; then
    ...
    MODEL_NAME=./checkpoints/Qwen3-VL-8B/OLoRA-CL/model/${PREV_DATASET}
fi
...
OUTPUT_DIR=./checkpoints/Qwen3-VL-8B/OLoRA-CL/training/${CUR_DATASET}
MERGE_SAVE_PATH=./checkpoints/Qwen3-VL-8B/OLoRA-CL/model/${CUR_DATASET}

mkdir -p ${OUTPUT_DIR}

past_num=$((TASK_ID - 1))
config_files_str=""
checkpoint_base_dir="./checkpoints/Qwen3-VL-8B/OLoRA-CL/training"
