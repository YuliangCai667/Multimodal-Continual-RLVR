...
OUTPUT_DIR=./checkpoints/Qwen3-VL-8B/KeepLoRA-CL/training/${CUR_DATASET}
MERGE_SAVE_PATH=./checkpoints/Qwen3-VL-8B/KeepLoRA-CL/model/${CUR_DATASET}
INIT_LORA_FROM_GRADIENTS=./checkpoints/Qwen3-VL-8B/KeepLoRA-CL/lora_gradients/${CUR_DATASET}/gradients_merged.pt
mkdir -p ${OUTPUT_DIR}
