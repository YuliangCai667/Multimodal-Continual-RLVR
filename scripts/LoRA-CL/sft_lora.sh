...
if [ $TASK_ID -eq 1 ]; then
    ...
    MODEL_NAME=./checkpoints/Qwen3-VL-2B/LoRA-CL/model/${PREV_DATASET}
fi
...
OUTPUT_DIR=./checkpoints/Qwen3-VL-2B/LoRA-CL/training/${CUR_DATASET}
MERGE_SAVE_PATH=./checkpoints/Qwen3-VL-2B/LoRA-CL/model/${CUR_DATASET}
