...
if [ $TASK_ID -eq 1 ]; then
    ...
    MODEL_NAME=./checkpoints/Qwen3-VL-4B/KeepLoRA-CL/model/${PREV_DATASET}
fi
...
OUTPUT_DIR=./checkpoints/Qwen3-VL-4B/KeepLoRA-CL/training/${CUR_DATASET}
MERGE_SAVE_PATH=./checkpoints/Qwen3-VL-4B/KeepLoRA-CL/model/${CUR_DATASET}
INIT_LORA_FROM_GRADIENTS=./checkpoints/Qwen3-VL-4B/KeepLoRA-CL/lora_gradients/${CUR_DATASET}/gradients_merged.pt
mkdir -p ${OUTPUT_DIR}
...
deepspeed src/train/train_sft.py \
    ...
    --init_lora_from_gradients $INIT_LORA_FROM_GRADIENTS \
    --freeze_lora_A True \
